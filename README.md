...
> อยากรู้ว่าระบบทำงานยังไง — ข้อมูลเดินจากไหนไปไหน ไฟล์ไหนทำอะไร และทำไมถึงออกแบบแบบนั้น
...
ส่วนคำอธิบายว่าแต่ละ endpoint ถูกเรียกจากตรงไหนของ UI อยู่ใน [ARCHITECTURE.md](ARCHITECTURE.md)
